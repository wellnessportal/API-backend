...
public class UserRewardService {
    ...
    public UserRewardService(UserRewardsRepository userRewardsRepository, RewardsService rewardsService, UsersRepository usersRepository) {
        this.userRewardsRepository = userRewardsRepository;
        this.rewardsService = rewardsService;
        this.usersRepository = usersRepository;
    }

    public void addUserReward(String id) {
        Users person = usersRepository.findById(id).orElse(null);
        if(person!=null){
            String r = rewardsService.getRandomReward(person.getEmail_id(), person.getRating());
